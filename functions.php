<?php
/**
 * Topical Roots functions and definitions.
 *
...
if ( ! function_exists( 'topicalroots_setup' ) ) :
/**
 ...
 */
function topicalroots_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Topical Roots, use a find and replace
	 * to change 'topicalroots' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'topicalroots', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'topicalroots' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'topicalroots_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'topicalroots_setup' );
 ...
 */
function topicalroots_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'topicalroots_content_width', 640 );
}
add_action( 'after_setup_theme', 'topicalroots_content_width', 0 );
 ...
 */
function topicalroots_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'topicalroots' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'wp_enqueue_scripts', 'topicalroots_scripts' );
